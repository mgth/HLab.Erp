...
public class IconsListViewModel : Core.EntityLists.EntityListViewModel<Icon>, IMvvmContextProvider
{
    ...
    protected override bool ImportCanExecute(Action<string> errorAction) => true;
    ...
    protected override bool DeleteCanExecute(Icon arg, Action<string> errorAction) => true;
