...
using HLab.Erp.Core.Avalonia.Views;
...
public class ListFilterConfiguratorAvaloniaImplementation : IListFilterConfiguratorPlatformImplementation
{
    public static void Initialize()
    {
        ListFilterConfiguratorExtension.Implementation = new ListFilterConfiguratorAvaloniaImplementation();
    }
